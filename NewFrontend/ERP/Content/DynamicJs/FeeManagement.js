...
{ headerName: labelArray['$ACADEMIC_YEAR$'], field: 'acYr', hide: false, headerTooltip: '', width: 150, cellClass: 'grid-center', cellStyle: '', suppressMenu: false, export: true},
...
{ headerName: labelArray['$COURSE$'], field: 'crsNm', hide: false, headerTooltip: '', width: 150, cellClass: 'grid-center', cellStyle: '', suppressMenu: false, export: true},
...
{ headerName: labelArray['$FEE_NAME$'], field: 'fNm', hide: false, headerTooltip: '', width: 150, cellClass: 'grid-center', cellStyle: '', suppressMenu: false, export: true},
...
{ headerName: labelArray['$PAYMENT_TYPE$'], field: 'pType', hide: false, headerTooltip: '', width: 150, cellClass: 'grid-center', cellStyle: '', suppressMenu: false, export: true},
{ headerName: labelArray['$TERMS$'], field: 'trms', hide: false, headerTooltip: '', width: 150, cellClass: 'grid-center', cellStyle: '', suppressMenu: false, export: true},
{ headerName: labelArray['$FEE_AMOUNT$'], field: 'amt', hide: false, headerTooltip: '', width: 150, cellClass: 'grid-center', cellStyle: '', suppressMenu: false, export: true}
 ];
